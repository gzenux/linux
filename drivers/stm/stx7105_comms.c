...
void __init stx7105_configure_pwm(struct stx7105_pwm_config *config)
{
	...
	if (config) {
		...
		case stx7105_pwm_out0_pio4_4:
			stx7105_pwm_platform_data.out_channel_config[0].enabled = 1;
			stx7105_pwm_platform_data.out_pad_config[0]	=
		...
		case stx7105_pwm_out1_pio4_5:
			stx7105_pwm_platform_data.out_channel_config[1].enabled = 1;
			stx7105_pwm_platform_data.out_pad_config[1]	=
