						...
						struct mmc_ios *ios)
{
	...
	case MMC_SIGNAL_VOLTAGE_330:
		...
		/* Call custom callback to switch pad to 3.3V config */
		if (host->ops->platform_vsense)
			host->ops->platform_vsense(host,
	...
	case MMC_SIGNAL_VOLTAGE_180:
		...
		/* Call custom callback to switch pad to 1.8V config
		 * on some HW w/o voltage regulator but with own internal
		 * logic to switch to 1.8V
		 */
		if (host->ops->platform_vsense)
			host->ops->platform_vsense(host,
