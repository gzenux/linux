			      ...
			      int burst_len, u32 dma_tx, u32 dma_rx, int atds)
{
	 ...
	 * effect. Note: burst length is not an integer, should
	 *  be one of the defined values in linux/stmmac.h
	 *
	 * Note:
	...
	value |= burst_len & DMA_AXI_BURST_LEN_MASK;
	/*
	 * Set the Maximum Read / Write outstanding Request limit.
	 * Same note as above, maximum RD/WR OSR might be limited
	 * by HW synthesis choices, RO bits won't be set.
	 */
	value |= DMA_AXI_WR_OSR_LMT_MASK;
	value |= DMA_AXI_RD_OSR_LMT_MASK;
